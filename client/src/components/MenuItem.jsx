            ...
            <div className="menu-item-card" onClick={handleCardClick}>
                ...
                {currentUser?.isAdmin && restaurantOwnerId === currentUser.id && (
                    <button
                        ...
                        title="Edit Product"
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="var(--wolt-dark)" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="edit-pencil-svg">
